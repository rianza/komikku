...
class SyncPreferences(
    ...
    val clientHost: Preference<String> = preferenceStore.getString("connection_sync_client_host", "https://sync.tachiyomi.org")
    ...
    // KMK -->
    val webDavUrl: Preference<String> = preferenceStore.getString("connection_webdav_url", "")
    val webDavUsername: Preference<String> = preferenceStore.getString("connection_webdav_username", "")
    val webDavPassword: Preference<String> = preferenceStore.getString("connection_webdav_password", "")
    val webDavFolder: Preference<String> = preferenceStore.getString("connection_webdav_folder", "komikku")
    // KMK <--
