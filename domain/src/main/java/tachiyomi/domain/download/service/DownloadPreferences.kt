...
class DownloadPreferences(
    ...
    // SY -->
    val includeChapterUrlHash: Preference<Boolean> = preferenceStore.getBoolean("download_include_chapter_url_hash", false)
    // SY <--

    // KMK -->
    val downloadCacheRenewInterval: Preference<Int> = preferenceStore.getInt("download_cache_renew_interval", 1)
    // KMK <--
