...
class SyncPreferences(
    ...
    // KMK -->
    val webDavUrl: Preference<String> = preferenceStore.getString("webdav_url", "")
    val webDavUsername: Preference<String> = preferenceStore.getString("webdav_username", "")
    val webDavPassword: Preference<String> = preferenceStore.getString("webdav_password", "")
    val webDavFolder: Preference<String> = preferenceStore.getString("webdav_folder", "komikku")
    // KMK <--
