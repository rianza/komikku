...
private data class TrackDateRemoverScreen(
    ...
    override fun Content() {
        ...
        val viewModel = viewModel<Model>(
            // KMK -->
            key = "track-date-remove-${track.id}",
            // KMK <--
            factory = Model.Factory,
            extras = CreationExtras {
                set(Model.TRACK_KEY, track)
