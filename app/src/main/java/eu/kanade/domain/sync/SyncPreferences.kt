...
class SyncPreferences(
    ...
    // KMK -->
    val webDavUrl = preferenceStore.getString("webdav_url", "")
    val webDavUsername = preferenceStore.getString("webdav_username", "")
    val webDavPassword = preferenceStore.getString("webdav_password", "")
    val webDavFolder = preferenceStore.getString("webdav_folder", "komikku")
    // KMK <--
    ...
    // KMK -->
    val showSyncingProgressBanner = preferenceStore.getBoolean(
