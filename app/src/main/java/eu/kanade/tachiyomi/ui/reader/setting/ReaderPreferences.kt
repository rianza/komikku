...
class ReaderPreferences(
    ...
    // KMK -->
    val pagedDoubleTapZoomEnabled: Preference<Boolean> = preferenceStore.getBoolean("pref_enable_double_tap_zoom_paged", true)

    val webtoonPinchToZoomEnabled: Preference<Boolean> = preferenceStore.getBoolean("pref_enable_pinch_to_zoom_webtoon", true)
    // KMK <--

    val imageScaleType: Preference<Int> = preferenceStore.getInt("pref_image_scale_type_key", 1)

    // KMK -->
    val webtoonScaleType: Preference<WebtoonScaleType> = preferenceStore.getEnum("pref_webtoon_scale_type_key", WebtoonScaleType.FIT)

    val longStripGapSmartScale: Preference<Boolean> = preferenceStore.getBoolean("pref_webtoon_smart_scale_long_strip_gap", false)
    // KMK <--
    ...
    // KMK -->
    val landscapeZoomType: Preference<LandscapeZoomScaleType> = preferenceStore.getEnum("landscape_zoom_type", LandscapeZoomScaleType.FIT)
    // KMK <--
